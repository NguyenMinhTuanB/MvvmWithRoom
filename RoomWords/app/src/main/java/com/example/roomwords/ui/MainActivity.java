...
import com.example.roomwords.viewmodel.WordViewModel;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView recyclerWords = findViewById(R.id.recycler_words);
        final WordAdapter wordAdapter = new WordAdapter(this);
        ...
        helper.attachToRecyclerView(recyclerWords);
    }
